...
if (isset($_POST["btnDelete"])) {
    ...
    echo "<script>window.location.href='ViewRecord.php?notify=$full_name has been deleted!';</script>";
}
?>
...
<center>
    <form method="POST">
        ...
        <h4> You are about to delete this user: <font color="red"><?php echo $full_name; ?></font>
        </h4>
